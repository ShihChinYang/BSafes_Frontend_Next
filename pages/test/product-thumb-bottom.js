...
import QuantityCounter from "../../components/beautico/uitils/QuantityCounter";

import BSafesStyle from '../../styles/BSafes.module.css'

const ProductThumbBottom = () => {
  const [selectColor, setselectColor] = useState(0);

  const handleItemClick = (index) => {
    setselectColor(index);
  };
  const testSlideSettings = useMemo(() => {
    return {
                  ...
                  <div className="shop-details-img style-2">
                    <div className="tab-content" id="v-pills-tabContent">
                      ...
                      <div className="tab-pane fade" id="v-pills-img2" role="tabpanel">
                        <Swiper key={2} {...slideSettings} className="swiper exclusive-slider">
                          <div className="swiper-wrapper">
                            <SwiperSlide key={21} className="swiper-slide">
                              <div className="shop-details-tab-img">
                                <img src="/assets/img/inner-page/shop-details-tab-img1.png" alt="" />
                              </div>
                            </SwiperSlide>
                            <SwiperSlide key={22} className="swiper-slide">
                              <div className="shop-details-tab-img">
                                <img src="/assets/img/inner-page/shop-details-tab-img2.png" alt="" />
                              </div>
                            </SwiperSlide>
                      ...
                      <div className="tab-pane fade" id="v-pills-img5" role="tabpanel">
                        <Swiper {...slideSettings} className="swiper exclusive-slider">
                          <div className="swiper-wrapper">
                            <SwiperSlide className="swiper-slide">
                              <div className="shop-details-tab-img">
                      ...
                      <div className="tab-pane fade" id="v-pills-img6" role="tabpanel">
                        <Swiper {...slideSettings} className="swiper exclusive-slider">
                          <div className="swiper-wrapper">
                            <SwiperSlide className="swiper-slide">
                              <div className="shop-details-tab-img">
                      ...
                      <div className="tab-pane fade" id="v-pills-img7" role="tabpanel">
                        <Swiper {...slideSettings} className="swiper exclusive-slider">
                          <div className="swiper-wrapper">
                            <SwiperSlide className="swiper-slide">
                              <div className="shop-details-tab-img">
                      ...
                      <div className="tab-pane fade" id="v-pills-img8" role="tabpanel">
                        <Swiper {...slideSettings} className="swiper exclusive-slider">
                          <div className="swiper-wrapper">
                            <SwiperSlide className="swiper-slide">
                              <div className="shop-details-tab-img">
                    ...
                    <div className="nav nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                      ...
                      <button className="nav-link" id="v-pills-img6-tab" data-bs-toggle="pill" data-bs-target="#v-pills-img6" type="button" role="tab" aria-controls="v-pills-img2" aria-selected="false">
                        <img src="/assets/img/inner-page/shop-details-nav-img6.png" alt="" />
                      </button>
                      <button className="nav-link" id="v-pills-img7-tab" data-bs-toggle="pill" data-bs-target="#v-pills-img7" type="button" role="tab" aria-controls="v-pills-img3" aria-selected="false">
                        <img src="/assets/img/inner-page/shop-details-nav-img7.png" alt="" />
                      </button>
                      <button className="nav-link" id="v-pills-img8-tab" data-bs-toggle="pill" data-bs-target="#v-pills-img8" type="button" role="tab" aria-controls="v-pills-img4" aria-selected="false">
                        <img src="/assets/img/inner-page/shop-details-nav-img8.png" alt="" />
                      </button>
                    </div>
                  </div>
                                ...
                                <ul className="author-comment mb-100">
                                  <li>
                                    ...
                                    <div className="comment-content">
                                      ...
                                      <p>Odio tellus, dignissim fermentumara purus nec, consequat
                                        dapibus metus.Vivamusut urna world classo mauris, faucibus
                                        at egestas quis, fermentum egetonav neque. Duisonajt
                                        pharetra lectus nec risusonota and we are always support our
                                        customer support available.</p>
...
export default ProductThumbBottom
