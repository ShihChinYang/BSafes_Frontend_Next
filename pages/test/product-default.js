...
import useMagneticHover from "../../components/beautico/hooks/useMagneticHover";
              ...
              <div className="col-lg-6">
                <div className="shop-details-img">
                  <div className="tab-content" id="v-pills-tabContent">
                    <div style={{ overflow: 'hidden' }} className="tab-pane fade show active" id="v-pills-img1" role="tabpanel">
                    ...
                    <div style={{ overflow: 'hidden' }} className="tab-pane fade" id="v-pills-img2" role="tabpanel">
                    ...
                    <div style={{ overflow: 'hidden' }} className="tab-pane fade" id="v-pills-img3" role="tabpanel" aria-labelledby="v-pills-img3-tab">
                    ...
                    <div style={{ overflow: 'hidden' }} className="tab-pane fade" id="v-pills-img4" role="tabpanel" aria-labelledby="v-pills-img4-tab">
