        ...
        return new Promise(async (resolve, reject) => {
            ...
            try {
                ...
                if (!workspaceId.startsWith("d:")) {
                    ...
                    const demoWorkspaceInfo = getDemoWorkspaceInfo();
                    displayTeamName = demoWorkspaceInfo.demoWorkspaceName;
                    teamKey = demoWorkspaceInfo.demoWorkspaceKey;
                    teamSearchKey = demoWorkspaceInfo.demoWorkspaceSearchKey;
                    teamSearchIV = demoWorkspaceInfo.demoWorkspaceSearchIV;
                }
