                                    ...
                                    <div className="product-card2">
                                        ...
                                        <div className="product-card-img double-img">
                                            <Link legacyBehavior href="/shop">
                                                <a>
                                                    <img src="https://placehold.co/400x400" alt="" className="img1" />
                                                    <img src="https://placehold.co/400x400" alt="" className="img2" />
                                                </a>
                                            </Link>
...
export default StorePageFeatures