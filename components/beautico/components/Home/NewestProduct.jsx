              ...
              <div className="swiper-wrapper">
                  ...
                  <div className="product-card hover-btn">
                    <div className="product-card-img double-img">
                      <Link legacyBehavior href="/shop/product-default">
                        <a>
                        <img src="/assets/img/home1/product-img-13.png" alt="" className="img1" />
                        <img src="/assets/img/home1/product-img-12.png" alt="" className="img2" />
                        <div className="countdown-timer">
                          <ul data-countdown={endTime}>
                            <li className="times" data-days={days}>{days} <span>{days}</span> <span>D</span></li>
                            <li>
                              :
                            </li>
                            <li className="times" data-hours={hours}>{hours} <span>Hours</span> <span>H</span></li>
                            <li>
                              :
                            </li>
                            <li className="times" data-minutes={minutes}>{minutes} <span>Minutes</span> <span>M</span></li>
                            <li>
                              :
                            </li>
                            <li className="times" data-seconds={seconds}>{seconds}<span></span> <span>S</span></li>
                          </ul>
                        </div>
                        <div className="batch">
                          <span>-15%</span>
                    ...
                    <div className="product-card-content">
                      <h6><Link legacyBehavior href="/shop/product-default"><a  className="hover-underline">Soothing Aloe Bliss</a></Link></h6>
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="product-card hover-btn">
                    ...
                    <div className="product-card-content">
                      <h6><Link legacyBehavior href="/shop/product-default"><a  className="hover-underline">Calming Skin Relief</a></Link></h6>
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="product-card hover-btn">
                    ...
                    <div className="product-card-content">
                      <h6><Link legacyBehavior href="/shop/product-default"><a  className="hover-underline">Timeless Amber Essence</a></Link></h6>
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="product-card hover-btn">
                    ...
                    <div className="product-card-content">
                      <h6><Link legacyBehavior href="/shop/product-default"><a  className="hover-underline">Crimson Dreamy Hue</a></Link></h6>
