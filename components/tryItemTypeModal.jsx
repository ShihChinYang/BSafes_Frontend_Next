            ...
            <ListGroup>
                ...
                { 
                    ...
                    <>
                        ...
                        <ListGroup.Item className={`${BSafesStyle.notebookItem} pt-3 pb-3`} id='Diary' action onClick={()=>optionSelected('A002')}><i className="fa fa-calendar me-2 fs-5 fw-light" aria-hidden="true"></i><em className="fs-5 fw-light">A002</em></ListGroup.Item>
                    </>
                }
            </ListGroup>
        </Modal.Body>
