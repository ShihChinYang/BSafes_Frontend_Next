...
import DiaryPagePanel from "./diaryPagePanel";
...
export default function DiaryPageCommon({ demo = false }) {
    const debugOn = false;
                ...
                <PageItemWrapper itemId={router.query.itemId}>
                    ...
                    <DiaryTopControlPanel
                        ...
                        onCoverClicked={() => {
                            ...
                            router.push(`/${product}/d:${parts[1]}:${parts[2]}:${parts[3]}?initialDisplay=cover`)
                        }}
                        onContentsClicked={() => {
                            const parts = pageItemId.split(':');
                            router.push(`/${product}/contents/d:${parts[1]}:${parts[2]}:${parts[3]}`)
                        }}
                    />
                    <Row id="BSafesPage">
