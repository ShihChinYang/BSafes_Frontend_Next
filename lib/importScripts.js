...
export const Excalidraw = Promise.all([
    import(/* webpackChunkName: 'Excalidraw' */'@excalidraw/excalidraw'),
]);

export const FontsConfig = Promise.all([
    import(/* webpackChunkName: 'FontsConfig' */'../resolved_fonts.json'),
]);
