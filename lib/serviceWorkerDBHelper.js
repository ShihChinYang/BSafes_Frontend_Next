...
export const deleteAnItemInServiceWorkerDBTable = (params) => {
    return new Promise(async (resolve, reject) => {
        debugLog(debugOn, "deleteAnItemInServiceWorkerDBTable");
        navigator.serviceWorker.getRegistration("/").then((registration) => {
            debugLog(debugOn, "registration: ", registration);
            if (registration) {
                let messageChannel = new MessageChannel();
...
export const writeDataToServiceWorkerDB = (params) => {
    return new Promise(async (resolve, reject) => {
        debugLog(debugOn, "writeDataToServiceWorkerDB");
        navigator.serviceWorker.getRegistration("/").then((registration) => {
            debugLog(debugOn, "registration: ", registration);
